...
int call_rgs(char **args, char **front, int *exe_ret);
int run_rgs(char **args, char **front, int *exe_ret);
int handle_rgs(int *exe_ret);
int check_rgs(char **args);
...
int proc_flie_cmnd(char *file_path, int *exe_ret);
#endif /* _SHELL_H_ */
